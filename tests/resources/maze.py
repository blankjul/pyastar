...
class MazeProblem(Problem):
    ...
    def __init__(self, maze, start, goal) -> None:
        ...
        self.maze = MazeSolver(maze)

    def get_neighbors(self, node):
        return self.maze.neighbors(node)

    def get_costs(self, node_a, node_b):
        return self.maze.distance_between(node_a, node_b)

    def get_heuristic(self, node):
        return self.maze.heuristic_cost_estimate(node, self.goal)
